...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { day: @period.day, period_num: @period.period_num, subject_id: @period.subject_id, time_table_id: @period.time_table_id }
    end
  ...
  test "should update period" do
    patch :update, id: @period, period: { day: @period.day, period_num: @period.period_num, subject_id: @period.subject_id, time_table_id: @period.time_table_id }
    assert_redirected_to period_path(assigns(:period))
  end
