...
class FeesControllerTest < ActionController::TestCase
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post :create, fee: { amount: @fee.amount, month: @fee.month, student_id: @fee.student_id, user_id: @fee.user_id }
    end
  ...
  test "should update fee" do
    patch :update, id: @fee, fee: { amount: @fee.amount, month: @fee.month, student_id: @fee.student_id, user_id: @fee.user_id }
    assert_redirected_to fee_path(assigns(:fee))
  end
