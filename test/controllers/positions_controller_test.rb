...
class PositionsControllerTest < ActionController::TestCase
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post :create, position: { category_id: @position.category_id, name: @position.name }
    end
  ...
  test "should update position" do
    patch :update, id: @position, position: { category_id: @position.category_id, name: @position.name }
    assert_redirected_to position_path(assigns(:position))
  end
